...
const Footer = () => {
    return (
        <footer className="footer footer-center p-10 bg-primary text-primary-content  h-[350px] " style={{ backgroundImage: 'url(https://i.ibb.co/f4L9JcS/pexels-asad-photo-maldives-1450340.jpg)' }}>
            <aside>
                ...
                <p className="font-bold">
                    Dream Resorts Limited <br />Providing many resorts facilities since 2000
                </p>
